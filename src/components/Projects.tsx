              ...
              <div className="bg-zinc-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-zinc-700">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className={`inline-flex items-center gap-2 text-sm font-medium transition-colors ${project.status === "Completed" ? "text-[#777fcf] hover:text-[#5a62b5]" : "text-gray-500 cursor-not-allowed"}`}
                    target="_blank"
